...
for (let index = 0; index < starWarsCharacters.length; index++) {
  if (starWarsCharacters[index].gender === "female") {
    famaleCharacters.push(starWarsCharacters[index]);
  }
}
...
while (x < starWarsCharacters.length) {
  crewMass = crewMass + starWarsCharacters[x].mass;
  x++;
}
...
for (let y = 0; y < starWarsCharacters.length; y++) {
  switch (starWarsCharacters[y].gender) {
    case "n/a":
      starWarsCharacters[y].gender = "robot";
      console.log(starWarsCharacters[y]);
      break;
  }
}
...
console.log(charactersNames);
console.log(famaleCharacters);
for (let w = 0; w < charactersNames.length; w++) {
  switch (true) {
    case famaleCharacters[0].name === charactersNames[w].name:
      delete charactersNames[w];
      break;
    case famaleCharacters[1].name === charactersNames[w].name:
      delete charactersNames[w];
      break;
  }
}
